  ...
  return(
    ...
    <div className="w3-display-container">
      ...
      <div className=" w3-border-top">
          <div className="w3-bar w3-panel">
              <div className="w3-bar-item w3-center w3-border w3-btn" style={{width:"25%"}}>
    ...
    <div className="w3-container">
       <div className="w3-white w3-container w3-round-xlarge">
         <br /><label><strong>User description</strong></label>
            <p>
              editable text...editable text...editable text...editable text...editable text...editable text...editable text...editable text...editable text...
            </p>
       </div>
    </div>
