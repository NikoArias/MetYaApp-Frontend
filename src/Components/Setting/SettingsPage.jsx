        ...
        <div className="w3-container">
             <div className="w3-white w3-container w3-round-xlarge">
                 <h1><strong>Settings</strong></h1>
                  ...
                  <p>
                    <Link to="/profile" className="w3-btn w3-blue w3-block">Update profile</Link>
                  </p>
               </div>
        </div>
                          <br />
           ...
           <div className="w3-white w3-container w3-round-xlarge">
             ...
             <hr />
               <div className="W3-container w3-bar-block">
                     <div className="w3-bar-item w3-btn">option 1</div>
                       <div className="w3-bar-item  w3-btn">option2</div>
                         <div className="w3-bar-item  w3-btn">option 3</div>
                    <br />
               </div>
          </div>
      </div>
